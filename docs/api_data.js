define({ "api": [
  ...
  },
  {
    ...
    "name": "PostRecipe",
    "group": "Recipe",
    "description": "<p>Create a new recipe</p> <ul> <li>The authenticated user will be used as author</li> <li>The name must be at least 3 characters long</li> <li>The servings amount must be at least 1</li> </ul>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
